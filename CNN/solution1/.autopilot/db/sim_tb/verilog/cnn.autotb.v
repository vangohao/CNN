...
`define AESL_DEPTH_Parameter_r 1
`define AUTOTB_TVIN_gmem  "./c.cnn.autotvin_gmem.dat"
`define AUTOTB_TVIN_In_r  "./c.cnn.autotvin_In_r.dat"
`define AUTOTB_TVIN_Out_r  "./c.cnn.autotvin_Out_r.dat"
`define AUTOTB_TVIN_W  "./c.cnn.autotvin_W.dat"
`define AUTOTB_TVIN_Parameter_r  "./c.cnn.autotvin_Parameter_r.dat"
`define AUTOTB_TVIN_gmem_out_wrapc  "./rtl.cnn.autotvin_gmem.dat"
`define AUTOTB_TVIN_In_r_out_wrapc  "./rtl.cnn.autotvin_In_r.dat"
`define AUTOTB_TVIN_Out_r_out_wrapc  "./rtl.cnn.autotvin_Out_r.dat"
`define AUTOTB_TVIN_W_out_wrapc  "./rtl.cnn.autotvin_W.dat"
`define AUTOTB_TVIN_Parameter_r_out_wrapc  "./rtl.cnn.autotvin_Parameter_r.dat"
`define AUTOTB_TVOUT_gmem  "./c.cnn.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "./impl_rtl.cnn.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = -1;
parameter LENGTH_gmem = 18160;
parameter LENGTH_In_r = 1;
parameter LENGTH_Out_r = 1;
parameter LENGTH_W = 1;
parameter LENGTH_Parameter_r = 1;
...
AESL_axi_master_gmem AESL_AXI_MASTER_gmem(
    ...
    .TRAN_gmem_In_r (In_r),
    .TRAN_gmem_Out_r (Out_r),
    .TRAN_gmem_W (W),
    .TRAN_gmem_Parameter_r (Parameter_r),
...
reg end_Parameter_r;
reg [31:0] size_Parameter_r;
reg [31:0] size_Parameter_r_backup;
