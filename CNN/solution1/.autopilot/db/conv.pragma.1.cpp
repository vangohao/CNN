...
# 4 "./conv.h" 2
# 1 "C:/Xilinx/Vivado/2018.3/win64/tools/clang/bin/../lib/clang/3.1/../../../x86_64-w64-mingw32/include\\memory.h" 1 3
...
# 1 "C:/Xilinx/Vivado/2018.3/win64/tools/clang/bin/../lib/clang/3.1/../../../x86_64-w64-mingw32/include\\_mingw.h" 1 3
# 9 "C:/Xilinx/Vivado/2018.3/win64/tools/clang/bin/../lib/clang/3.1/../../../x86_64-w64-mingw32/include\\memory.h" 2 3



extern "C" {
# 38 "C:/Xilinx/Vivado/2018.3/win64/tools/clang/bin/../lib/clang/3.1/../../../x86_64-w64-mingw32/include\\memory.h" 3
}
# 5 "./conv.h" 2
...
void cnn(d_type* In, d_type* Out, d_type* W, int *Parameter)
{
_ssdm_op_SpecResourceLimit(16, "fmul", "", "", "");
_ssdm_op_SpecResourceLimit(16, "fadd", "", "", "");
...
_ssdm_op_SpecInterface(In, "m_axi", 0, 0, "", 0, 3072, "gmem", "slave", "", 16, 16, 16, 16, "", "");
_ssdm_op_SpecInterface(Out, "m_axi", 0, 0, "", 0, 14400, "gmem", "slave", "", 16, 16, 16, 16, "", "");
_ssdm_op_SpecInterface(W, "m_axi", 0, 0, "", 0, 432, "gmem", "slave", "", 16, 16, 16, 16, "", "");
_ssdm_op_SpecInterface(Parameter, "m_axi", 0, 0, "", 0, 256, "gmem", "slave", "", 16, 16, 16, 16, "", "");
...
_ssdm_SpecLoopFlatten(0, "");
 loop_CHout:for(int cho = 0; cho < CHout; cho++)
     {
_ssdm_SpecLoopFlatten(0, "");
_ssdm_op_SpecLoopTripCount(1, 64, 32, "");
_ssdm_Unroll(1, 0, 4, "");
