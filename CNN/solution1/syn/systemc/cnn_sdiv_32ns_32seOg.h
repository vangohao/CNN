...
// ==============================================================
#ifndef __cnn_sdiv_32ns_32seOg__HH__
#define __cnn_sdiv_32ns_32seOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_sdiv_32ns_32seOg) {
    ...
    SC_CTOR(cnn_sdiv_32ns_32seOg):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
