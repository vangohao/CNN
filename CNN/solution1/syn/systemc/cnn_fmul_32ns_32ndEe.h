...
// ==============================================================
#ifndef __cnn_fmul_32ns_32ndEe__HH__
#define __cnn_fmul_32ns_32ndEe__HH__
#include "ACMP_fmul.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_fmul_32ns_32ndEe) {
    ...
    SC_CTOR(cnn_fmul_32ns_32ndEe):  ACMP_fmul_U ("ACMP_fmul_U") {
        ACMP_fmul_U.clk(clk);
