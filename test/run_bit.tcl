create_project project_1 ./project_1 -force -part xc7z020clg400-1
set_property board_part tul.com.tw:pynq-z2:part0:1.0 [current_project]
create_bd_design "design_1"
update_compile_order -fileset sources_1
create_bd_cell -type ip -vlnv xilinx.com:ip:processing_system7:5.5 processing_system7_0
apply_bd_automation -rule xilinx.com:bd_rule:processing_system7 -config {make_external "FIXED_IO, DDR" apply_board_preset "1" Master "Disable" Slave "Disable" }  [get_bd_cells processing_system7_0]
set_property ip_repo_paths ../CNN [current_project]
update_ip_catalog
...
cd ./project_1/project_1.runs/design_1_auto_pc_0_synth_1/
source design_1_auto_pc_0.tcl
cd ../design_1_axi_smc_0_synth_1
source design_1_axi_smc_0.tcl
cd ../design_1_processing_system7_0_0_synth_1
source design_1_processing_system7_0_0.tcl
cd ../design_1_rst_ps7_0_100M_0_synth_1
source design_1_rst_ps7_0_100M_0.tcl
cd ../design_1_cnn_0_0_synth_1
source design_1_cnn_0_0.tcl
cd ../synth_1
